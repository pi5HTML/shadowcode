...
###  To run
just simply download and open, updates are easy: just open the file, it will say if there is an update and you can download straght from the file
it is all simple UI, i want to try to make it as easy to use as possible, please tell me if you would like a feture to help you use it
