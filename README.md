...
* **Multiple Ciphers:** Built-in support for Vigenère, Atbash, Index Substitution, and Shift ciphers.
* **Portable:** No installation required—just open the `.html` file in any modern web browser.
...
---
*Disclaimer: This tool is intended for basic message obfuscation and educational purposes.*
